...
CREATE TABLE IF NOT EXISTS `cadastro_imoveis`.`usuario` (
  ...
  INDEX `FK_usuario_grupo_idx` (`codigo_gru` ASC),
...
CREATE TABLE IF NOT EXISTS `cadastro_imoveis`.`estados` (
  ...
  INDEX `fk_estados_pais1_idx` (`codigo_pai` ASC),
...
CREATE TABLE IF NOT EXISTS `cadastro_imoveis`.`cidades` (
  ...
  INDEX `fk_cidades_estados_idx` (`codigo_est` ASC),
...
CREATE TABLE IF NOT EXISTS `cadastro_imoveis`.`paginas` (
  ...
  INDEX `fk_paginas_menu1_idx` (`codigo_men` ASC),
...
CREATE TABLE IF NOT EXISTS `cadastro_imoveis`.`paginas_grupo` (
  ...
  INDEX `fk_paginas_has_grupo_grupo1_idx` (`codigo_gru` ASC),
  INDEX `fk_paginas_has_grupo_paginas1_idx` (`codigo_pag` ASC),
...
CREATE TABLE IF NOT EXISTS `cadastro_imoveis`.`pessoa` (
  ...
  INDEX `fk_pessoa_cidades1_idx` (`codigo_cid` ASC),
...
CREATE TABLE IF NOT EXISTS `cadastro_imoveis`.`imovel` (
  ...
  INDEX `fk_imovel_tipo_imovel1_idx` (`codigo_tpi` ASC),
  PRIMARY KEY (`codigo_imo`),
  INDEX `fk_imovel_pessoa1_idx` (`codigo_pes` ASC),
  INDEX `fk_imovel_cidades1_idx` (`codigo_cid` ASC),
...
CREATE TABLE IF NOT EXISTS `cadastro_imoveis`.`especificacoes` (
  ...
  INDEX `fk_especificacoes_tipo_imovel1_idx` (`codigo_tpi` ASC),
  INDEX `fk_especificacoes_especificacoes1_idx` (`codigo_pai` ASC),
  CONSTRAINT `fk_especificacoes_tipo_imovel1`
    FOREIGN KEY (`codigo_tpi`)
    REFERENCES `cadastro_imoveis`.`tipo_imovel` (`codigo_tpi`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_especificacoes_especificacoes1`
    FOREIGN KEY (`codigo_pai`)
...
CREATE TABLE IF NOT EXISTS `cadastro_imoveis`.`fotos_imovel` (
  ...
  INDEX `fk_fotos_imovel_imovel1_idx` (`codigo_imo` ASC),
